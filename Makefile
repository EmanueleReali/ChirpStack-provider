# ====================================================================================
# Setup Project
PROJECT_NAME := provider-chirpstack
...
XPKGS = provider-chirpstack
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-chirpstack: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider ChirpStack CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider ChirpStack controllers
...
# This target prepares repo for your provider by replacing all "chirpstack"
